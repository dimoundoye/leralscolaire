...
router.get(
  '/attendance-history/:classeId',
  auth,
  checkProfRole,
  requireProfOfClasse('classeId'),
  profPortalController.getAttendanceHistory
);

// --- 5. GRILLES DE NOTES ---
router.get(
  '/grades/:classeId/:matiereId',
  auth,
  checkProfRole,
  requireProfOfClasse('classeId', 'matiereId'),
  profPortalController.getClassGrades
);
...
router.get(
  '/baremes/:etablissementId',
  auth,
  checkProfRole,
  requireProfAffiliation('etablissementId'),
  profPortalController.getBaremes
);
...
// --- 9. SUIVI PEDAGOGIQUE ---
router.get(
  '/pedagogie/:classeId/:matiereId',
  auth,
  checkProfRole,
  requireProfOfClasse('classeId', 'matiereId'),
  profPortalController.getPedagogyStats
);
