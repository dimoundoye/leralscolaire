...
const officeBacController = {
  ...
  // GET /carte-regionale
  async getCarteRegionale(req, res) {
  ...
  // GET /candidats/historique/:eleve_id
  async getCandidatHistorique(req, res) {
    try {
      const result = await db.query(
        `
  ...
  // PUT /candidats/:id/dossier
  async updateCandidatDossier(req, res) {
  ...
  // PUT /candidats/:id/suspendre
  async suspendreCandidat(req, res) {
  ...
  // POST /candidats/generer-numeros
  async genererNumerosTable(req, res) {
  ...
  // POST /coefficients
  async saveCoefficients(req, res) {
  ...
  // PUT /candidats/:id/resultats
  async saveCandidatResultats(req, res) {
    const {
      moyenne,
      mention,
      statut_resultat,
  ...
  // PUT /candidats/:id/verrouiller
  async verrouillerCandidat(req, res) {
  ...
  // GET /verifier-qr/:hash
  async verifierQrReleve(req, res) {
    try {
      const result = await db.query(
        `
  ...
  // POST /publier
  async publierResultats(req, res) {
  ...
  // GET /etablissements
  async listEtablissements(req, res) {
    try {
      const result = await db.query(`
  ...
  // POST /demande-public
  async submitDemandePublique(req, res) {
    const {
      type_demande,
      nom,
      prenom,
  ...
  // PUT /demandes/:id/rejeter
  async rejeterDemande(req, res) {
  ...
  async createLivret(req, res) {
    ...
    `,
      ...
      res
        .status(201)
        .json({ message: 'Livret scolaire transmis avec succès au Jury du BAC !', livret: result.rows[0] });
    } catch (err) {
      console.error(err);
  ...
  // PUT /livrets/:id/valider
  async validerLivret(req, res) {
  ...
  async listJurys(req, res) {
    ...
    try {
      ...
      const result = await db.query(query, params);
      // Le hash du mot de passe temporaire ne quitte jamais le serveur
      res.json(result.rows.map(({ password_hash: _hash, ...jury }) => jury));
    } catch (err) {
      console.error(err);
  ...
  // GET /centres-examen
  async listCentresExamen(req, res) {
    try {
      const result = await db.query(`
  ...
  // POST /centres-examen
  async createCentreExamen(req, res) {
    const {
      nom_centre,
      type_centre,
      centre_principal_id,
  ...
  // PUT /centres-examen/:id
  async updateCentreExamen(req, res) {
    const {
      nom_centre,
      type_centre,
      centre_principal_id,
  ...
  // DELETE /centres-examen/:id
  async deleteCentreExamen(req, res) {
    try {
  ...
  async createJury(req, res) {
    ...
    `,
      ...
      `,
        ...
        console.log(
          `✉️ [CONVOCATION & PDF ENVOYÉS] Message expédié à ${profEmail} pour la présidence du ${numero_jury}`
        );
      }
  ...
  // PUT /candidats/:id/reattribuer-jury
  async reattribuerJury(req, res) {
  ...
  // POST /dispatch-alphabetique
  async dispatchAlphabetique(req, res) {
  ...
  // POST /transmettre-livrets-zone
  async transmettreLivretsZone(req, res) {
    try {
  ...
  // POST /restituer-livrets
  async restituerLivrets(req, res) {
  ...
  // GET /settings/expiration-date
  async getExpirationDate(req, res) {
    try {
      const result = await db.query(
        "SELECT setting_value FROM office_bac_settings WHERE setting_key = 'session_expiration_date'"
      );
  ...
  // POST /settings/expiration-date
  async saveExpirationDate(req, res) {
...
module.exports = officeBacController;
