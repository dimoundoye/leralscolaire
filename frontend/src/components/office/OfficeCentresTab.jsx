    ...
    <div className="ob-tab-pane">
      <div className="ob-page-header">
        <div>
          ...
          <p>
            Définition des Établissements Hôtes (Centres Principaux) et des Centres Secondaires rattachés pour
            désenclaver les candidats
          </p>
        </div>
        <div className="ob-page-header-right" style={{ display: 'flex', gap: 8 }}>
          <button className="ob-btn ob-btn-ghost" onClick={fetchCentres}>
      ...
      <div className="ob-filters-bar mb-4">
        ...
        <select value={centreTypeFilter} onChange={(e) => setCentreTypeFilter(e.target.value)}>
        ...
        <select value={centreRegionFilter} onChange={(e) => setCentreRegionFilter(e.target.value)}>
              ...
              filteredCentres.map((c) => {
                ...
                return (
                  <tr key={c.id}>
                    ...
                    <td>
                      {isSecondaire ? (
                        <span style={{ color: '#0284c7', fontSize: 12, fontWeight: 600 }}>
                          {c.centre_principal_nom || 'Centre Principal'}
                        </span>
                      ) : (
                    ...
                    <td>
                      <div>
                        <span className="ob-badge ob-badge-region" style={{ fontSize: 10.5, padding: '2px 6px' }}>
                          {c.region}
                        </span>
                      </div>
                    ...
                    <td>
                      <strong style={{ color: '#334155', fontSize: 12.5 }}>
                        {c.effectif_previsionnel ? c.effectif_previsionnel + ' candidats' : '—'}
                      </strong>
                    </td>
                    <td>
