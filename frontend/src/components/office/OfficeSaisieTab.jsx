    ...
    <div className="ob-tab-pane">
      <div className="ob-page-header">
        <div>
          ...
          <p>
            Saisie des épreuves, calcul automatique de la moyenne, délibérations (1er et 2nd Tour) et verrouillage par
            le jury
          </p>
        </div>
      ...
      <div className="ob-saisie-cards">
        {loading ? (
          <div className="ob-loading">
            <Loader2 size={28} className="ob-spin" />
          </div>
        ) : candidats.length === 0 ? (
              ...
              <div className="ob-saisie-card-left">
                ...
                <div>
                  ...
                  <div className="ob-saisie-meta">
                    {c.type_examen} {c.annee} · Série {c.serie} · Jury {c.jury || '—'} ·{' '}
