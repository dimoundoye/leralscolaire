    ...
    <div className="ob-tab-pane">
      ...
      >
        ...
        >
          <div>
            ...
            >
              <MapPin size={22} style={{ color: '#2563eb' }} /> Cartographie Nationale &amp; Statistiques des 14 Régions
              du Sénégal
            </h3>
            <p style={{ margin: '4px 0 0', fontSize: 13, color: '#64748b' }}>
              Cliquez sur une région ou filtrez par métrique pour consulter la vue globale sur le plan national
              (Établissements, Profs, Jurys, Candidats BAC &amp; BFEM, Moyennes).
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              {[
                ...
                const formattedVal =
                  typeof val === 'number'
                    ? activeMetric.includes('moyenne')
                      ? val.toFixed(2) + '/20'
                      : activeMetric.includes('taux')
                        ? val + '%'
                        : val
                    : val;
                  ...
                  >
                    <div
                      style={{
                        ...
                        boxShadow: isSelected ? '0 3px 12px rgba(245, 158, 11, 0.6)' : '0 2px 5px rgba(0,0,0,0.3)',
                        display: 'flex',
                        alignItems: 'center',
                        gap: 3,
                        whiteSpace: 'nowrap',
            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
                  <div
                    style={{ background: '#ffffff', border: '1px solid #e2e8f0', borderRadius: 10, padding: '12px' }}
                  >
                    <div
                      style={{
                        fontSize: 11,
                ...
                <div style={{ background: '#ffffff', border: '1px solid #fbcfe8', borderRadius: 12, padding: '14px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, fontSize: 12 }}>
                    ...
                    >
                      ...
                      <div style={{ fontWeight: 900, fontSize: 15, color: '#831843' }}>
                        {data.eleves_femmes || 0} élève(s)
                      </div>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      ...
                      <div style={{ fontWeight: 900, fontSize: 15, color: '#075985' }}>
                        {data.eleves_hommes || 0} élève(s)
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="ob-stats-grid ob-stats-grid-full">
        <div className="ob-stat-card ob-stat-total">
          ...
          <div>
            <div className="ob-stat-num">{stats?.total_eleves ?? stats?.total ?? '—'}</div>
            <div className="ob-stat-label">Total Élèves inscrits</div>
          </div>
        </div>
        <div className="ob-stat-card" style={{ background: '#fdf2f8', borderColor: '#fbcfe8' }}>
          <div className="ob-stat-icon" style={{ background: '#fce7f3', color: '#db2777' }}>
            <Users size={22} />
          </div>
          <div>
            <div className="ob-stat-num" style={{ color: '#9d174d' }}>
              {stats?.eleves_femmes ?? '—'}
            </div>
            <div className="ob-stat-label" style={{ color: '#831843' }}>
              Filles / Femmes ({stats?.taux_feminisation || 0}%)
            </div>
          </div>
        </div>
        <div className="ob-stat-card" style={{ background: '#f0f9ff', borderColor: '#bae6fd' }}>
          <div className="ob-stat-icon" style={{ background: '#e0f2fe', color: '#0284c7' }}>
            <UserCheck size={22} />
          </div>
          <div>
            <div className="ob-stat-num" style={{ color: '#0369a1' }}>
              {stats?.eleves_hommes ?? '—'}
            </div>
            <div className="ob-stat-label" style={{ color: '#075985' }}>
              Garçons / Hommes
            </div>
          </div>
        </div>
        <div className="ob-stat-card ob-stat-publie">
          ...
          <div>
            <div className="ob-stat-num">{stats?.publies ?? '—'}</div>
            <div className="ob-stat-label">Résultats publiés</div>
          </div>
        </div>
        ...
        {stats?.admis && stats?.publies && (
          <div className="ob-stat-card ob-stat-taux">
            ...
            <div>
              <div className="ob-stat-num">{Math.round((stats.admis / stats.publies) * 100)}%</div>
              <div className="ob-stat-label">Taux global réussite</div>
            </div>
          </div>
        )}
      </div>
        ...
        <div className="ob-mid-row mt-6">
          <div className="ob-card">
            <h3 className="ob-card-title">
              <Activity size={18} /> Évolution du Taux de Réussite Inter-années
            </h3>
            <div style={{ width: '100%', height: 260 }}>
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart
                  data={[...(stats.par_annee || [])].reverse()}
          ...
          <div className="ob-card">
            <h3 className="ob-card-title">
              <MapPin size={18} /> Répartition des Admis par Région
            </h3>
            <div style={{ width: '100%', height: 260 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  layout="vertical"
                  data={stats.par_region || []}
      ...
      {stats?.par_region?.length > 0 && (
        <div className="ob-card mt-6">
          <h3 className="ob-card-title">
            <MapPin size={18} /> Performance par Région du Sénégal
          </h3>
                ...
                {stats.par_region.map((r) => {
                  ...
                  return (
                    <tr key={r.region}>
                      ...
                      <td>
                        <strong>{r.moyenne_region ? parseFloat(r.moyenne_region).toFixed(2) + '/20' : '—'}</strong>
                      </td>
                    </tr>
                  );
                })}
