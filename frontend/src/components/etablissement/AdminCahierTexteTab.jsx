        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
          ...
          <div className="form-group" style={{ margin: 0 }}>
            ...
            >
              ...
              {classes
                .filter((c) => c.annee_scolaire === cahierAnneeFilter)
                .map((c) => (
      ...
      >
        <div className="cahier-admin-list" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {cahierLoading ? (
            ...
            (() => {
              const displayedEntries = cahierEntries.filter(
                (e) => !cahierAnneeFilter || e.annee_scolaire === cahierAnneeFilter
              );
                ...
                displayedEntries.map((entry) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <ShieldCheck size={14} />{' '}
                        {entry.visa_admin ? "Visé par l'Admin (Cliquer pour annuler)" : 'Viser le Cahier de Texte'}
                      </button>
                    </div>
