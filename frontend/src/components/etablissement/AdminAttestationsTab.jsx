        ...
        <div className="table-container">
          <table className="data-table">
            ...
            <tbody>
                  ...
                  return (
                    <tr key={item.id}>
                      <td>
                        ...
                        <div style={{ fontSize: '10px', color: 'var(--slate-400)', fontFamily: 'monospace' }}>
                      ...
                      <td
                        ...
                        title={item.motif_demande}
                      >
                        {item.motif_demande || (
                          <span style={{ color: 'var(--slate-300)', fontStyle: 'italic' }}>Aucun</span>
                        )}
                      </td>
                      <td>
                        <span
              ...
              {attestations.filter((item) => attestationFilter === 'all' || item.statut === attestationFilter)
                .length === 0 && (
                <tr>
