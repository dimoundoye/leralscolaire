      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              <h2 style={{ fontSize: '1.25rem', fontWeight: 800, margin: 0, color: '#131e6c' }}>
                Dossier Scolaire Individuel
              </h2>
              <p style={{ fontSize: '0.85rem', color: '#64748b', margin: 0 }}>
                Fiche synthétique 360° et registre disciplinaire
              </p>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div style={{ padding: '28px' }}>
          {loading ? (
            <div style={{ padding: '40px', textAlign: 'center', color: '#64748b', fontWeight: 500 }}>
              Chargement du dossier scolaire...
            </div>
          ) : (
            <>
              ...
              >
                <div>
                  ...
                  <div style={{ fontWeight: 800, fontSize: '1.1rem', color: '#131e6c' }}>
                    {eleve.prenom} {eleve.nom}
                  </div>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#64748b', textTransform: 'uppercase', fontWeight: 700 }}>
                    IUP / Identifiant Unique
                  </span>
                  <div style={{ fontWeight: 700, color: '#131e6c' }}>
                    {eleve.identifiant_national || eleve.ine || 'N/A'}
                  </div>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#64748b', textTransform: 'uppercase', fontWeight: 700 }}>
                ...
                <div>
                  ...
                  <div style={{ fontWeight: 700, color: '#0f172a' }}>
                    {eleve.telephone_parent || eleve.telephone || 'N/A'}
                  </div>
                </div>
              </div>
              ...
              {signalements.length === 0 ? (
                ...
                >
                  ✨ Le dossier disciplinaire de cet élève est entièrement vierge. Aucune sanction ni convocation
                  enregistrée.
                </div>
              ) : (
                        ...
                        {item.type_action === 'CONVOCATION' && (
                          ...
                          >
                            {item.date_rendez_vous && (
                              <span>
                                <strong>RDV le :</strong> {new Date(item.date_rendez_vous).toLocaleString('fr-FR')}
                              </span>
                            )}
                            {item.lieu_rendez_vous && (
                              <span>
                                <strong>Lieu :</strong> {item.lieu_rendez_vous}
                              </span>
                            )}
                            <span>
