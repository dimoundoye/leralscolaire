...
const AdminMessagesTab = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="card-box"
        style={{ padding: '16px', display: 'flex', flexDirection: 'column', height: '100%', overflowY: 'auto' }}
      >
        ...
        {(() => {
          ...
          const filteredClasses = classes.filter(
            (c) => c.annee_scolaire === messagesAnneeFilter && (!q || c.nom.toLowerCase().includes(q))
          );
                          ...
                          <div>
                            <div
                              style={{
                                fontSize: '13px',
                                fontWeight: 700,
                                color: isActive ? '#15803d' : 'var(--text-slate-800)',
                              }}
                            >
                              {c.nom}
                            </div>
                          ...
                          <div>
                            <div
                              style={{
                                fontSize: '13px',
                                fontWeight: 700,
                                color: isActive ? 'var(--primary-color)' : 'var(--text-slate-800)',
                              }}
                            >
                              {name}
                            </div>
                          ...
                          <div>
                            <div
                              style={{
                                fontSize: '13px',
                                fontWeight: 700,
                                color: isActive ? '#334155' : 'var(--text-slate-800)',
                              }}
                            >
                              {name}
                            </div>
      ...
      >
        {activeChatContact ? (
          ...
          >
            ...
            <h4 style={{ margin: 0, color: 'var(--text-slate-800)', fontSize: '15px', fontWeight: 800 }}>
              Aucune conversation sélectionnée
            </h4>
            <p style={{ fontSize: '12px', marginTop: '4px' }}>
              Choisissez un enseignant ou un élève dans la liste de gauche pour commencer à chatter.
            </p>
          </div>
        )}
      </div>
