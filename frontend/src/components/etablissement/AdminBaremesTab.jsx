      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Définissez les appréciations automatiques selon les notes. Elles seront appliquées automatiquement dans le
      ...
      <div className="table-block" style={{ maxWidth: '800px', padding: '24px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          ...
          <button
            ...
            onClick={() =>
              setBaremes([...baremes, { note_min: '', note_max: '', appreciation: '', couleur: '#64748b' }])
            }
          >
            + Ajouter un palier
          </button>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flex: '0 0 auto' }}>
                <input
                  ...
                  onChange={(e) => {
                    const n = [...baremes];
                    n[idx] = { ...n[idx], couleur: e.target.value };
                    setBaremes(n);
                  }}
                  style={{
                    width: '36px',
              ...
              <div style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const n = [...baremes];
                    n[idx] = { ...n[idx], note_min: e.target.value };
                    setBaremes(n);
                  }}
                  style={{
                    width: '100%',
              ...
              <div style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const n = [...baremes];
                    n[idx] = { ...n[idx], note_max: e.target.value };
                    setBaremes(n);
                  }}
                  style={{
                    width: '100%',
              ...
              <div style={{ flex: 2 }}>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const n = [...baremes];
                    n[idx] = { ...n[idx], appreciation: e.target.value };
                    setBaremes(n);
                  }}
                  style={{
                    width: '100%',
        ...
        >
          <p style={{ margin: 0, fontSize: '12px', color: '#6366f1', fontWeight: '600' }}>
            Ces barèmes s'appliquent automatiquement dans l'onglet saisie des notes du portail enseignant. Dès qu'un
            professeur entre une note, l'appréciation est calculée et affichée en lecture seule selon votre grille.
          </p>
        </div>
      </div>
    </div>
