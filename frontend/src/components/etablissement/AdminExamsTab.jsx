      ...
      <div className="page-header">
        ...
        <div className="flex gap-2 items-center">
          ...
          >
            ...
            {classes
              .filter((c) => c.annee_scolaire === examsAnneeFilter)
              .map((c) => (
          ...
          <button
            className="btn"
            onClick={handleTransmettreLivretsZone}
            style={{
              background: '#059669',
              borderColor: '#059669',
              color: '#ffffff',
                ...
                {proposedDevoirs.map((prop) => (
                  <tr key={prop.id} style={{ background: '#ffffff' }}>
                    <td className="font-bold">
                      {prop.prof_prenom} {prop.prof_nom}
                    </td>
                    ...
                    <td>
                      <span
                        ...
                        style={{ padding: '2px 8px', fontSize: '9.5px', fontWeight: 700 }}
                      >
                        {prop.type_examen}
                      </span>
                    </td>
                      ...
                      <tr key={ex.id}>
                        <td>
                          {(() => {
                            ...
                            const timeStr = ex.date_examen.includes('T')
                        ...
                        <td>
                          <span
                            ...
                            style={{ padding: '4px 10px', fontSize: '10px', fontWeight: 700 }}
                          >
                            {ex.type_examen}
                          </span>
                        </td>
