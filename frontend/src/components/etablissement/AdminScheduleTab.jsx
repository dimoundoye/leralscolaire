        ...
        <div className="flex gap-2 items-center">
          <select
            ...
            onChange={(e) => {
              ...
              setScheduleClassId(v);
              if (v) {
                fetchSchedule(v);
                fetchScheduleMatieres(v);
              }
            }}
          >
            <option value="">Choisir une classe</option>
            {classes
              .filter((c) => c.annee_scolaire === scheduleAnneeFilter)
              .map((c) => (
          ...
          <button
            ...
            onClick={() => {
              fetchScheduleMatieres(scheduleClassId);
            ...
            <thead>
              <tr>
                {['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi'].map((day) => (
                  <th key={day} style={{ textAlign: 'center', fontWeight: 700 }}>
                    {day}
                  </th>
                ))}
              </tr>
