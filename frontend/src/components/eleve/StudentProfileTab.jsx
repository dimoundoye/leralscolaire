      ...
      <div className="profile-section card-box">
        <div className="profile-header-banner">
          <div className="profile-header-avatar">
            {profile?.photo_url ? (
              ...
              <div className="avatar-placeholder-large">{profile ? `${profile.prenom[0]}${profile.nom[0]}` : 'EL'}</div>
            )}
          </div>
          <div className="profile-header-meta">
            ...
            <span className="official-badge">
              <CheckCircle2 size={12} /> Profil État Sénégalais Certifié
            </span>
          </div>
        </div>
        ...
        <div className="profile-details-grid">
          ...
          <div className="details-group">
            ...
            <div className="detail-item">
              <span className="label">
                <Mail size={14} /> E-mail d'accès
              </span>
              <span className="val">{profile?.email}</span>
            </div>
            <div className="detail-item">
              <span className="label">
                <User size={14} /> Contact parent
              </span>
              <span className="val" style={{ whiteSpace: 'pre-line' }}>
                {profile?.coordonnees_parent || 'Non renseigné'}
              </span>
            </div>
          </div>
          ...
          <div className="details-group full-width">
            ...
            <div className="detail-item">
              <span className="label">
                <GraduationCap size={14} /> Établissement
              </span>
              <span className="val">
                {profile?.etablissement_nom} ({profile?.etablissement_region}, {profile?.etablissement_ville})
              </span>
            </div>
            <div className="detail-item">
              <span className="label">
                <BookOpen size={14} /> Classe
              </span>
              <span className="val">
                {profile?.classe_nom} (Niveau: {profile?.statut})
              </span>
            </div>
          </div>
        </div>
