...
export const StudentSidebar = ({ isSidebarCollapsed, setIsSidebarCollapsed, tab, navigate }) => {
  return (
    <aside className={`sd-sidebar ${isSidebarCollapsed ? 'collapsed' : ''}`}>
      ...
      <nav className="sd-nav">
        ...
        <button
          ...
          onClick={() => navigate('/student/dashboard/portfolio')}
        >
          <Award size={18} /> <span>Mon Portfolio & CV</span>
        </button>
        <button
          className={`nav-item ${tab === 'grades' ? 'active' : ''}`}
          onClick={() => navigate('/student/dashboard/grades')}
        >
          <BookOpen size={18} /> <span>Notes & Bulletins</span>
        </button>
        <button
          className={`nav-item ${tab === 'simulator' ? 'active' : ''}`}
          onClick={() => navigate('/student/dashboard/simulator')}
        >
          <Percent size={18} /> <span>Simulateur de moyenne</span>
        </button>
        <button
          className={`nav-item ${tab === 'evolution' ? 'active' : ''}`}
          onClick={() => navigate('/student/dashboard/evolution')}
        >
        ...
        <button
          className={`nav-item ${tab === 'cahier-texte' ? 'active' : ''}`}
          onClick={() => navigate('/student/dashboard/cahier-texte')}
        >
          <BookMarked size={18} /> <span>Cahier de Texte</span>
        </button>
        <button
          className={`nav-item ${tab === 'exams' ? 'active' : ''}`}
          onClick={() => navigate('/student/dashboard/exams')}
        >
          <GraduationCap size={18} /> <span>Résultats BAC / BFEM</span>
        </button>
        <button
          className={`nav-item ${tab === 'messages' ? 'active' : ''}`}
        ...
        <button
          ...
          onClick={() => navigate('/student/dashboard/ai-assistant')}
        >
          <Sparkles size={18} /> <span>Assistant IA Pédagogique</span>
        </button>
        <button
          className={`nav-item ${tab === 'discipline' ? 'active' : ''}`}
          onClick={() => navigate('/student/dashboard/discipline')}
        >
          <Scale size={18} /> <span>Vie Scolaire & Remarques</span>
        </button>
        <button
          className={`nav-item ${tab === 'attestation' ? 'active' : ''}`}
          onClick={() => navigate('/student/dashboard/attestation')}
        >
...
export const StudentMobileDrawer = ({ isMobileMenuOpen, setIsMobileMenuOpen, profile, tab, navigate }) => {
    ...
    >
      <div className="mobile-drawer" onClick={(e) => e.stopPropagation()}>
        ...
        <nav className="drawer-nav">
          <button
            className={`drawer-nav-item ${tab === 'overview' ? 'active' : ''}`}
            onClick={() => {
          ...
          <button
            className={`drawer-nav-item ${tab === 'profile' ? 'active' : ''}`}
            onClick={() => {
          ...
          <button
            className={`drawer-nav-item ${tab === 'portfolio' ? 'active' : ''}`}
            onClick={() => {
              navigate('/student/dashboard/portfolio');
              setIsMobileMenuOpen(false);
            }}
          >
            <Award size={18} /> <span>Mon Portfolio & CV</span>
          ...
          <button
            className={`drawer-nav-item ${tab === 'grades' ? 'active' : ''}`}
            onClick={() => {
          ...
          <button
            className={`drawer-nav-item ${tab === 'simulator' ? 'active' : ''}`}
            onClick={() => {
              navigate('/student/dashboard/simulator');
              setIsMobileMenuOpen(false);
            }}
          >
            <Percent size={18} /> <span>Simulateur de moyenne</span>
          ...
          <button
            className={`drawer-nav-item ${tab === 'evolution' ? 'active' : ''}`}
            onClick={() => {
              navigate('/student/dashboard/evolution');
              setIsMobileMenuOpen(false);
            }}
          >
            <Activity size={18} /> <span>Courbe d'Évolution</span>
          ...
          <button
            className={`drawer-nav-item ${tab === 'schedule' ? 'active' : ''}`}
            onClick={() => {
          ...
          <button
            className={`drawer-nav-item ${tab === 'cahier-texte' ? 'active' : ''}`}
            onClick={() => {
              navigate('/student/dashboard/cahier-texte');
              setIsMobileMenuOpen(false);
            }}
          >
            <BookMarked size={18} /> <span>Cahier de Texte</span>
          ...
          <button
            className={`drawer-nav-item ${tab === 'exams' ? 'active' : ''}`}
            onClick={() => {
          ...
          <button
            className={`drawer-nav-item ${tab === 'messages' ? 'active' : ''}`}
            onClick={() => {
          ...
          <button
            className={`drawer-nav-item ${tab === 'ai-assistant' ? 'active' : ''}`}
            onClick={() => {
          ...
          <button
            className={`drawer-nav-item ${tab === 'discipline' ? 'active' : ''}`}
            onClick={() => {
              navigate('/student/dashboard/discipline');
              setIsMobileMenuOpen(false);
            }}
          >
            <Scale size={18} /> <span>Vie Scolaire & Remarques</span>
          ...
          <button
            className={`drawer-nav-item ${tab === 'attestation' ? 'active' : ''}`}
            onClick={() => {
              navigate('/student/dashboard/attestation');
              setIsMobileMenuOpen(false);
            }}
          >
            <Award size={18} /> <span>Attestation d'Inscription</span>
