    ...
    >
      ...
      {showSuccessToast && lastSyncResult && (
        ...
        >
          ...
          <span>
            {lastSyncResult.count} action{lastSyncResult.count > 1 ? 's' : ''} synchronisée
            {lastSyncResult.count > 1 ? 's' : ''} avec succès sur le serveur !
          </span>
        </div>
      )}
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <div style={{ color: '#94a3b8', fontSize: '12px' }}>Vos saisies sont stockées localement.</div>
            </div>
          </div>
      ...
      {isSyncing && (
        ...
        >
          <RefreshCw size={18} color="#3b82f6" style={{ animation: 'spin 1s linear infinite' }} />
          <div>
            <div style={{ fontWeight: '600' }}>Synchronisation en cours...</div>
            <div style={{ color: '#94a3b8', fontSize: '12px' }}>Envoi automatique des données au serveur...</div>
          </div>
        </div>
      )}
