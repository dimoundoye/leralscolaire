              ...
              {filtered.length > 0 ? (
                filtered.map((aff) => (
                  <tr key={aff.etablissement_id} style={{ borderBottom: '1px solid #edf2f7' }}>
                    ...
                    <td style={{ padding: '12px', color: 'var(--text-slate-700)' }}>
                      {' '}
                      {aff.ville}, {aff.region}
                    </td>
                    <td style={{ padding: '12px' }}>
                      <span
                        style={{
                          ...
                          fontWeight: 700,
                          background:
                            aff.statut === 'ACCEPTE' ? '#dcfce7' : aff.statut === 'EN_ATTENTE' ? '#fef3c7' : '#fee2e2',
                          color:
                            aff.statut === 'ACCEPTE' ? '#15803d' : aff.statut === 'EN_ATTENTE' ? '#b45309' : '#b91c1c',
                        }}
                      >
                        {aff.statut === 'ACCEPTE'
                          ? 'Active / Rattaché'
