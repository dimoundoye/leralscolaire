      ...
      <div className={`card-box messages-contacts-panel ${activeChatContact ? 'mobile-hide' : ''}`}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            >
              <div
                style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#131e6c', flexShrink: 0 }}
              />
              <div>
                <div
                  style={{
              ...
              return (
                <div
                  ...
                  onClick={() =>
                    handleChatContactClick({
                      id: etab.admin_id,
                      name: `Admin – ${etab.etablissement_nom}`,
                      type: 'ADMIN',
                  ...
                  <div>
                    <div
                      style={{
                        fontSize: '13px',
                        fontWeight: 700,
                        color: isActive ? 'var(--primary-blue)' : 'var(--text-slate-800)',
                      }}
                    >
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {(() => {
              const yearClasses = (chatChannels.classes || []).filter(
                (cl) => !profAnneeFilter || !cl.annee_scolaire || cl.annee_scolaire === profAnneeFilter
              );
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            <div
                              style={{
                                fontSize: '12px',
                                fontWeight: 800,
                                color: isClassActive ? '#15803d' : '#1e293b',
                              }}
                            >
                              📢 Canal de Groupe {cl.classe_nom}
                            </div>
                            <div style={{ fontSize: '9.5px', color: '#64748b' }}>Message public à toute la classe</div>
                          </div>
                        </div>
                          ...
                          {filteredClassStudents.length > 0 ? (
                            filteredClassStudents.map((stud) => {
                              const isStudentActive =
                                activeChatContact?.id === stud.user_id && activeChatContact?.type === 'ELEVE';
                              return (
                                <div
                                  key={stud.user_id}
                                  onClick={() =>
      ...
      <div className={`card-box messages-chat-panel ${!activeChatContact ? 'mobile-hide' : ''}`}>
        {activeChatContact ? (
          <>
            ...
            >
              ...
              {activeChatContact.photo_url ? (
                <img
                  src={activeChatContact.photo_url}
                  alt=""
                ...
                <div
                  style={{
                    ...
                    height: '36px',
                    borderRadius: '50%',
                    background: activeChatContact.type === 'ELEVE' ? '#059669' : 'var(--primary-blue)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    color: 'white',
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <span style={{ fontSize: '11px', color: 'var(--text-slate-500)' }}>
                  {activeChatContact.type === 'ADMIN'
                    ? 'Canal Administrateur'
                    : activeChatContact.type === 'ELEVE'
                      ? `Discussion Élève • ${activeChatContact.classe_nom || 'Classe'}`
                      ...
                      >
                        {!isMe && (
                          <span style={{ fontWeight: 600, marginRight: '4px' }}>
                            {msg.expediteur_role === 'PROFESSEUR' ? 'ENSEIGNANT(E)' : msg.expediteur_nom_complet}
                          </span>
                        )}
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <button
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '4px', padding: '10px 14px', flexShrink: 0 }}
                >
          ...
          >
            ...
            <h4 style={{ margin: 0, fontSize: '15px', fontWeight: 800, color: 'var(--text-slate-700)' }}>
