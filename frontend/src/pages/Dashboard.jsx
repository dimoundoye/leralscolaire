          ...
          <div className="modal-card" style={{ maxWidth: '520px', width: '90%' }}>
            ...
            >
              ...
              <div>
                ...
                <strong>EN ATTENTE</strong>. Votre établissement conservera tous les droits d'édition jusqu'à
                l'acceptation finale par l'établissement d'accueil.
              </div>
            </div>
                ...
                {transferSearch.trim().length > 0 && !selectedTargetEtab && (
                  ...
                  >
                    {transferResults.length > 0 ? (
                      ...
                      <div
                        style={{ padding: '12px', fontSize: '12px', color: 'var(--slate-400)', textAlign: 'center' }}
                      >
                ...
                {selectedTargetEtab && (
                  ...
                  >
                    <div>
                      ...
                      >
                        <span
                          style={{ background: '#d1fae5', padding: '1px 6px', borderRadius: '4px', fontWeight: 700 }}
                        >
          ...
          >
            ...
            {viewTransferMotifModal.eleveNom && (
              <p className="text-muted" style={{ marginBottom: '14px', fontSize: '13px', fontWeight: 600 }}>
                Élève concerné :{' '}
                <strong style={{ color: 'var(--slate-800)' }}>{viewTransferMotifModal.eleveNom}</strong>
              </p>
            )}
          ...
          >
            ...
            >
              {confirmTransferModal.type === 'accept' && (
                <>
                  Voulez-vous vraiment <strong>accepter</strong> ce transfert ? L'élève sera rattaché à votre
                  établissement et les <strong>droits d'édition</strong> vous seront automatiquement transmis.
                </>
              )}
            ...
            {gradesModalLoading ? (
                                  ...
                                  <div className="grades-table-wrapper">
                                    ...
                                    <div className="grades-summary-footer">
                                      <div className="summary-card">
                                        ...
                                        <span
                                          className={`value ${periodData.moyenne_generale >= 10 ? 'pass' : 'fail'}`}
                                        >
                                    ...
                                    <form onSubmit={handleSaveJuryDecision} className="grades-jury-form">
                                      ...
                                      {(gradesModalSemestre === 'Semestre 2' ||
                                        gradesModalSemestre === 'Trimestre 3') && (
                                        <div
                                          style={{
                                            display: 'flex',
                                            gap: '16px',
              ...
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="mt-4 text-slate-500 font-semibold">
                  Impossible de récupérer les informations de l'élève.
                </p>
              </div>
            )}
          </div>
      ...
      {viewMotifModal && (
        <div className="modal-overlay" onClick={() => setViewMotifModal(null)}>
          <div className="modal-card" style={{ maxWidth: '480px' }} onClick={(e) => e.stopPropagation()}>
            ...
            >
              <div style={{ fontSize: '12px', color: 'var(--slate-500)', fontWeight: 600, marginBottom: '4px' }}>
                Élève
              </div>
            ...
            <form onSubmit={handleSendMessage}>
              <div className="input-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewMessage({ ...newMessage, destinataire_type: e.target.value, destinataire_id: '' })
                  }
                >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
              <div
                style={{
                  ...
                  justifyContent: 'center',
                  background:
                    auditConfirmAction.type === 'confirm' ? 'rgba(5, 150, 105, 0.1)' : 'rgba(220, 38, 38, 0.1)',
              ...
              <div className="form-row">
                <div className="input-group">
                  ...
                  <input
                    type="date"
                    value={
                      editingPreInscription.date_naissance ? editingPreInscription.date_naissance.split('T')[0] : ''
                    }
                    onChange={(e) =>
                      setEditingPreInscription({ ...editingPreInscription, date_naissance: e.target.value })
                    }
                    required
                  />
                </div>
                <div className="input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditingPreInscription({ ...editingPreInscription, lieu_naissance: e.target.value })
                    }
                    required
                  />
                </div>
              ...
              <div className="form-row">
                ...
                <div className="input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditingPreInscription({ ...editingPreInscription, nationalite: e.target.value })
                    }
                    required
                  />
                </div>
        ...
        <div className="modal-overlay" style={{ zIndex: 1200 }}>
          <div className="modal-card" style={{ maxWidth: 520, padding: '28px 30px' }}>
            ...
            >
              ...
              >
                • <strong>Règle de sécurité &amp; confidentialité :</strong> Chaque compte doit disposer d'une adresse
                email unique afin de garantir la réception sécurisée de ses accès et de ses notifications.
              </div>
            </div>
          ...
          >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <h3
                    style={{ margin: 0, fontSize: '15px', fontWeight: 800, color: '#ffffff', letterSpacing: '-0.01em' }}
                  >
