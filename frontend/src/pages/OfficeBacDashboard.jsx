            ...
            <form onSubmit={handleAddLivret} className="ob-modal-body">
              ...
              <div className="ob-form-row">
                <div className="ob-form-group">
                  ...
                  <select
                    value={newLivret.serie}
                    onChange={(e) => setNewLivret((f) => ({ ...f, serie: e.target.value }))}
                  >
            ...
            <form onSubmit={handleAddProfesseur} className="ob-modal-body">
              <div className="ob-form-row">
                <div className="ob-form-group">
                  ...
                  <select
                    value={newProf.sexe || 'M'}
                    onChange={(e) => setNewProf((f) => ({ ...f, sexe: e.target.value }))}
                  >
          ...
          <div className="ob-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="ob-modal-body">
              <p style={{ fontSize: 13, color: '#475569' }}>
                Un compte sécurisé a été automatiquement créé dans le système LeralScolaire. Transmettez ces
                ...
                <div className="ob-form-group">
                  ...
                  >
                    ...
                    {centresList
                      .filter(
                        (c) =>
                          (c.type_centre || 'PRINCIPAL') === 'PRINCIPAL' &&
                          (!newJury.region || c.region === newJury.region)
                      )
                      .map((c) => (
                          ...
                          {filtered.length > 0 ? (
                            filtered.slice(0, 10).map((p) => (
                              ...
                              >
                                ...
                                <span>
                                  <code>{p.identifiant_national || 'PROF'}</code> ·{' '}
                                  {p.matiere_principale || 'Enseignant'} ({p.region || 'Sénégal'})
                                </span>
                              </div>
                            ))
                          ) : (
            ...
            <div className="ob-modal-header">
              <div>
                ...
                <p style={{ fontSize: 13, color: '#64748b', margin: 0 }}>
                  {selectedCandidat.prenom} {selectedCandidat.nom} · N°{' '}
                  {selectedCandidat.numero_table || 'Non attribué'} · {selectedCandidat.type_examen}{' '}
                  {selectedCandidat.annee} · Série {selectedCandidat.serie}
                </p>
              </div>
          ...
          <div className="ob-modal ob-modal-wide" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="ob-modal-body">
              <div style={{ border: '2px solid #131e6c', borderRadius: 14, padding: 24, background: '#fff' }}>
                ...
                >
                  <div>
                    <h2 style={{ fontSize: 16, fontWeight: 900, color: '#131e6c', margin: 0 }}>
          ...
          <div className="ob-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handlePublier} className="ob-modal-body">
              <div className="ob-publi-warning">
                <AlertCircle size={18} />
                <p>
                  Une fois publiés, les résultats seront certifiés et consultables immédiatement sur le portail candidat
                  des élèves avec notifications.
                </p>
              </div>
        ...
        <div className="ob-modal-overlay" onClick={() => !rejectLoading && setRejectModalData(null)}>
          <div className="ob-modal" style={{ maxWidth: '560px' }} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleConfirmReject} className="ob-modal-body">
              ...
              >
                ⚠️ <strong>Notification automatique par email :</strong> Le motif renseigné ci-dessous sera
                immédiatement expédié à <strong>{rejectModalData.email}</strong> pour l'informer de la décision et lui
                indiquer les pièces à corriger.
              </div>
